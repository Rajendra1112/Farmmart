        ...
        <div id="content">
            ...
            <div >
                ...
                <form action="" method="get" class="d-sm-flex align-items-sm-center py-sm-3 px-md-3 farm">
                 <input type="text" placeholder="Farm name" value="<?php echo $farm_name;?>" name="farm_name" class="mx-sm-2 mx-3 my-sm-0 my-2 form-control"> 
                 ...
                 <button type="submit" value="Farm"  name="search_farm" class="btn btn-primary mx-3 my-sm-0 mb-2">search</button>
                 </form>
                 </div>
                 
            <div class="d-sm-flex py-sm-3 px-md-3 justify-content-center">

                <div class="row justify-content-center bg-white border" id="farmer">
                    <?php
                    getFarm();
                    searchFarm();
