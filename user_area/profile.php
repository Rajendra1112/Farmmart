...
<form class="border border-3 mb-4" action="" method='post' enctype="multipart/form-data" id="change_password">
  <div class="container rounded bg-white mb-1 ">
    <div class="row">
      ...
      <div class="mt-2 text-center"><button class="btn btn-primary profile-button border text-dark" type="submit" name="update_password" onclick="showSwal('auto-close')">Save Profile</button></div>
    </div>
  </div>
  </div>
</form>   