...
$get_orders = "Select * from `order_item` where order_id = '$order_id' and user_id=$user_id";
...
<div class='container mt-5'>
    <div class='d-flex justify-content-center row'>
        ...
        <a class='btn btn-success my-2' href='./account.php?confirm_payment&o=$order_id'>Confirm Payment</a>
