...
if($user_count==0){
  ...
  $phone = $user['phone'];
  $role_company_name = $user['role_company_name'];
...
if(isset($_POST['insert_product']) && $_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  if($product_title=='' or $product_price=='' or $discount=='' or $quantity=='' or $product_category=='' or $product_description=='' or $product_highlight==''  or $product_image=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
    ...
    //insert query
  $insert_query = "INSERT INTO `products`(user_id,product_title,product_keywords,quantity,product_price,discount,product_description,product_category,product_highlight,location,product_image,product_image1,product_image2,product_image3,date,type,status)
  VALUES ('$user_id','$product_title','$product_keywords',$quantity,$product_price,$discount,'$product_description','$product_category','$product_highlight','$location','$rand$product_image','$rand$product_image1','$rand$product_image2','$rand$product_image3',NOW(),'$type','$product_status')";
  $result = mysqli_query($con,$insert_query);
  if($result){
    productRequest($username, $email,$phone,$role_company_name,$message);
                ...
                <form action="" method="post" class="add_new_product" enctype="multipart/form-data">
                  ...
                  <div class="new_product_category">
                    ...
                    <select name="product_category" id="">
                      <?php
                      $select_query = "Select * from `category` where category_for='Farmer'";
                  ...
                  <label for="product_quantity">Product quantity:</label>
                    <input type="number" name="quantity" placeholder="product quantity in kg" required>
                  </div>

                  <div class="new_product_desctiption">
                    <label for="description">Describe Your Product</label>
                    <textarea name="product_description" id="" cols="30" rows="3"></textarea>
                  </div>
                  ...
                  <div class="new_product_desctiption">
                    ...
                    <textarea name="product_request" id="" cols="30" rows="3"></textarea>
                  </div>
                  <button type="submit" name="insert_product" value="Update Product" class="update text-white">Add Product</button>
                </form>
              </div>
            </div>