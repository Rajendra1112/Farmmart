...
if(isset($_POST['insert_blog']) && $_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  if($blog_title=='' or $blog_description=='' or $blog_highlight==''  or $blog_image=='' or $blog_image1=='' or $blog_image2=='' or $blog_image3==''){
    ...
    move_uploaded_file($temp_image,"../dashboard/blog_images/$rand$blog_image");
    move_uploaded_file($temp_image1,"../dashboard/blog_images/$rand$blog_image1");
    move_uploaded_file($temp_image2,"../dashboard/blog_images/$rand$blog_image2");
    move_uploaded_file($temp_image3,"../dashboard/blog_images/$rand$blog_image3");

    //insert query
  $insert_query = "INSERT INTO `blogs`(user_id,blog_title,blog_description,blog_highlight,blog_image,blog_image1,blog_image2,blog_image3,date)
  VALUES ($user_id,'$blog_title','$blog_description','$blog_highlight','$rand$blog_image','$rand$blog_image1','$rand$blog_image2','$rand$blog_image3',NOW())";
...
<div class="container">
              <div class="new_product">
                <form action="" method="post" class="add_new_product" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="insert_blog" value="Update Blog" class="update">Update Product</button>
                </form>
              </div>
            </div>