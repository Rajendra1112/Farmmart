...
if(isset($_POST['insert_product']) && $_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  if($product_title=='' or $product_price=='' or $product_after_price=='' or $product_category=='' or $product_description=='' or $product_highlight==''  or $product_image=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
    echo "<script>alert('Please fill all the avaliable fields')</script>";
  }
  else{
    //storing image to folder
    move_uploaded_file($temp_image,"./product_image/$rand$product_image");
    move_uploaded_file($temp_image1,"./product_image/$rand$product_image1");
    move_uploaded_file($temp_image2,"./product_image/$rand$product_image2");
    move_uploaded_file($temp_image3,"./product_image/$rand$product_image3");

    //insert query
  $insert_query = "INSERT INTO `farmer_products`(user_id,product_title,product_keywords,product_price,product_after_price,product_description,product_category,product_highlight,product_image,product_image1,product_image2,product_image3,date,status)
  VALUES ('$user_id','$product_title','$product_keywords',$product_price,$product_after_price,'$product_description','$product_category','$product_highlight','$product_image','$product_image1','$product_image2','$product_image3',NOW(),'$product_status')";
              ...
              <div class="new_product">
                <form action="" method="post" class="add_new_product" enctype="multipart/form-data">
                  ...
                  <div class="price">
                    ...
                    <input type="text" name="product_after_price" required>
                  </div>
