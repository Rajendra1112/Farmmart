      ...
      <div class="col-md-11 border-right m-auto">
        <div class="p-3 py-3">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a class="btn border border-success border-2" href="#change_profile">Change Profile</a>
            <a class="btn border border-success border-2" href="#change_password">Change Password</a>
          </div>
          <div class="row mt-3">
          ...
          <div class="mt-5 text-center" id="change_profile"><button class="btn btn-primary profile-button border text-dark" type="submit" name="user_update" onclick="showSwal('auto-close')">Save Profile</button></div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-11 border-right m-auto">
        <div class="p-3 py-2">
          ...
          <div class="mt-5 text-center" id="change_password"><button class="btn btn-primary profile-button border text-dark" type="submit" name="update_profile" onclick="showSwal('auto-close')">Save Profile</button></div>
      </div>
    </div>
  </div>
  </div>
</form>
<form class="border border-3 mb-4" action="" method='post' enctype="multipart/form-data" >
  <div class="container rounded bg-white mb-3 ">
    <div class="row">
      ...
      <div class="mt-4 text-center"><button class="btn btn-primary profile-button border text-dark" type="submit" name="update_password" onclick="showSwal('auto-close')">Save Profile</button></div>
    </div>
  </div>
  </div>
</form>