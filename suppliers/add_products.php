...
if(isset($_POST['insert_product']) && $_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  if($product_title=='' or $product_price=='' or $discount=='' or $product_category=='' or $product_description=='' or $product_highlight==''  or $product_image=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
    ...
    //insert query
  $insert_query = "INSERT INTO `products`(user_id,product_title,product_keywords,product_price,discount,product_description,product_category,product_highlight,location,product_image,product_image1,product_image2,product_image3,date,status)
  VALUES ('$user_id','$product_title','$product_keywords',$product_price,$discount,'$product_description','$product_category','$product_highlight','$location','$rand$product_image','$rand$product_image1','$rand$product_image2','$rand$product_image3',NOW(),'$product_status')";
...
<div class="container">
              <div class="new_product">
                <form action="" method="post" class="add_new_product" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="insert_product" value="Update Product" class="update">Add Blog</button>
                </form>
              </div>
            </div>