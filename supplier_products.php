...
<body>
  ...
  if (isset($_GET['supplier_id'])) {
    ...
    //select farm
    $select_supplier = "Select * from `user_table` where user_id=$supplier_id";
    $result_supplier = mysqli_query($con,$select_supplier);
    $supplier_data = mysqli_fetch_assoc($result_supplier);
    $supplier_name = $supplier_data['role_company_name'];
    //product count
    $select_product_query = "Select * from `products` where user_id=$supplier_id";
    ...
    $select_query = "Select * from `products`where user_id=$supplier_id order by rand()";
